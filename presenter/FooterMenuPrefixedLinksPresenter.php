<?php namespace Themes\Education\Presenter;
...
class FooterMenuPrefixedLinksPresenter extends Presenter
{
    ...
    {
        return '<li'.$this->getActiveState($item).'><a href="'.$item->getUrl().'" '.$item->getAttributes().'>'.$item->getIcon().' Jale Tezer '.$item->title.'</a></li>'.PHP_EOL;
    }
