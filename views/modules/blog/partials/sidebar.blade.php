<div class="tt-sidebar-wrapper" role="complementary">
    ...
    <div class="widget widget_categories">
        ...
        <ul>
            @foreach(app(\Modules\Blog\Repositories\CategoryRepository::class)->all() as $category)
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tt-popular-post-tab1" data-toggle="tab"
                       aria-expanded="true">{{ trans('themes::news.recent posts') }}</a>
                </li>
                <li class="">
                    <a href="#tt-popular-post-tab2" data-toggle="tab"
                       aria-expanded="false">{{ trans('themes::news.popular posts') }}</a>
                </li>
            </ul>
