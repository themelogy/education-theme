...
<div class="form-group<?php if ($required) {
  ...
  <div class="<?php echo $inputsize ?>">
    <div class="input-group">
      ...
      <input id="<?php echo $name ?>" name="<?php echo $name ?>" value="{!! old($name) !!}" type="text" placeholder="<?php echo $placeholder ?>" class="browser-default form-control <?php echo $inputheight ?>" <?php if ($required) {
    ?> required <?php 
} ?> />
    </div>
    <?php if ($helptext) {
