!function () {
    ...
    $(document).ready(function () {
        $("#preloader").delay(200).fadeOut("slow"), $("#materialize-menu-alt").html('<ul class="menuzord-menu">' + $("#menu-list").html() + "</ul>");
        if($("#materialize-menu").length > 0) {
            jQuery("#materialize-menu, #materialize-menu-alt").menuzord({indicatorFirstLevel: "<i class='fa fa-angle-down'></i>", indicatorSecondLevel: "<i class='fa fa-angle-right'></i>"});
        }
        ...
        if ($(window).on("scroll", function () {
            ...
            t > 768 && ($(this).scrollTop() > 1 ? $(".mainmenu").slideUp(function () {
                $(".menu-appear-alt").css({position: "fixed", top: 0, left: 0, width: t, zIndex: 99999}), $(".menu-appear-alt").slideDown()
            }) : $(".menu-appear-alt").slideUp(function () {
                $(".menu-appear-alt").css({position: "relative", top: 0, left: 0, width: t, zIndex: 99999}), $(".mainmenu").slideDown()
            })), $(".nav-bottom").css("z-Index", 1e5), e && ($(window).scrollTop() > e.top ? $(".nav-bottom").css({position: "fixed", top: "0px", left: "0px"}) : $(".nav-bottom").css({position: "fixed", top: e.top - $(window).scrollTop() + "px"}))
        ...
        }), $(".countdown").length > 0 && $(".countdown").countdown({date: "31 december 2017 12:00:00", format: "on"}), $(".tt-lightbox").length > 0 && $(".tt-lightbox").magnificPopup({type: "image", mainClass: "mfp-fade", removalDelay: 160, fixedContentPos: !1}), $(".popup-video").length > 0 && $(".popup-video").magnificPopup({disableOn: 700, type: "iframe", mainClass: "mfp-fade", removalDelay: 160, preloader: !1, fixedContentPos: !1}), $(".gallery-thumb").length > 0 && $(".gallery-thumb").flexslider({animation: "slide", controlNav: "thumbnails"}), $(".circle-thumb").length > 0 && $(".circle-thumb").flexslider({animation: "slide", controlNav: "thumbnails"}), $(".square-thumb").length > 0 && $(".square-thumb").flexslider({animation: "slide", controlNav: "thumbnails"}), $(".logo-thumb").length > 0 && $(".logo-thumb").flexslider({animation: "slide", controlNav: "thumbnails"}), $(".logo-thumb-right").length > 0 && $(".logo-thumb-right").flexslider({
            animation: "slide",
            controlNav: "thumbnails"
        }), $(".parallax-carousel").length > 0 && $(".parallax-carousel").flexslider({animation: "slide"}), $(".quote-carousel").length > 0 && $(".quote-carousel").owlCarousel({loop: !0, autoHeight: !0, responsive: {0: {items: 1}, 600: {items: 1}, 1000: {items: 1}}}), $(".featured-carousel").length > 0 && $(".featured-carousel").owlCarousel({loop: !0, margin: 12, responsive: {0: {items: 1}, 600: {items: 2}, 1000: {items: 3}}}), $(".seo-featured-carousel").length > 0 && $(".seo-featured-carousel").owlCarousel({loop: !0, margin: 30, responsive: {0: {items: 1}, 600: {items: 2}, 1000: {items: 4}}}), $(".blog-carousel").length > 0 && $(".blog-carousel").owlCarousel({loop: !0, margin: 26, responsive: {0: {items: 1}, 600: {items: 2}, 1000: {items: 3}}}), $(".project-carousel").length > 0 && $(".project-carousel").owlCarousel({loop: !0, responsive: {0: {items: 1}, 600: {items: 1}, 1000: {items: 1}}}), $(".career-carousel").length > 0 && $(".career-carousel").owlCarousel({
            loop: !0,
            autoPlay: !0,
